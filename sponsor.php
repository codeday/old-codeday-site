				...
				<div id="sponsor-table" class="text-center">
					<div class="clearfix">
						...
						<div class="column no-padding">
							...
							<p class="sponsor-table-price">$500 <span>per event</span></p>
							<p class="sponsor-table-location">Limit of 4 sponsors per location</p>
						</div>
						<div class="column no-padding">
							<h3 class="sponsor-table-type">Startup</h3>
							<p class="sponsor-table-price">$1,000</p>
							<p class="sponsor-table-location">Limit 4</p>
						</div>
						<div class="column no-padding">
							<h3 class="sponsor-table-type">API</h3>
							<p class="sponsor-table-price">$2,000</p>
							<p class="sponsor-table-location">Limit 3</p>
						</div>
						<div class="column no-padding">
						...
						<div class="column no-padding">
							...
							<p class="sponsor-table-location">Limit 1</p>
						</div>
					</div>
