	...
	<div id="splash-info" class="row text-center">
		...
		<div id="city-picker" class="round-corners text-left">
			<ul>
				...
				<li class="city-option"><a href="">Kirkland</a></li>
				<li class="city-option"><a href="">Seattle</a></li>
				<li class="city-option"><a href="">Bellevue</a></li>
			</ul>
		</div>
...
<div class="reg-splash"></div>
<div class="blurred-splash"></div>
