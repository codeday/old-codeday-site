  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    _ElementListEventStreamImpl: {
      ...
      listen$4$cancelOnError$onDone$onError: function(onData, cancelOnError, onDone, onError) {
        ...
        t2 = this.$ti;
        pool = new W._StreamPool(null, new H.JsLinkedHashMap(0, null, null, null, null, null, 0, [[P.Stream, t1], [P.StreamSubscription, t1]]), t2);
        pool._controller = new P._SyncBroadcastStreamController(null, pool.get$close(pool), 0, null, null, null, null, t2);
        for (t1 = this._targetList, t1 = new H.ListIterator(t1, t1.get$length(t1), 0, null), t3 = this._eventType; t1.moveNext$0();)
    ...
    _StreamPool: {
      ...
      add$1: function(_, stream) {
        ...
        if (t1.containsKey$1(stream))
          return;
        t2 = this._controller;
        t1.$indexSet(0, stream, W._EventStreamSubscription$(stream._html$_target, stream._eventType, t2.get$add(t2), false, H.getTypeArgumentByIndex(stream, 0)));
      },
      close$0: [function(_) {
        var t1, t2;
    ...
    api: function() {
      ...
      if (t1 == null) {
        ...
        t3.toString;
        t1.Base = t3.getAttribute("data-" + new W._DataAttributeMap(new W._ElementAttributeMap(t3))._toHyphenedName$1("apiBase"));
        t3 = t2.querySelector("body");
        t3.toString;
        t1.Public = t3.getAttribute("data-" + new W._DataAttributeMap(new W._ElementAttributeMap(t3))._toHyphenedName$1("apiPublic"));
        t2 = t2.querySelector("body");
        t2.toString;
    ...
    Api: {
      ...
      Request$3: function(endpoint, method, body) {
          ...
          while (true)
            switch ($async$goto) {
              ...
              case 3:
                ...
                $async$temp3 = J;
                $async$goto = 6;
                return P._asyncAwait(W.HttpRequest_request(t2 + "/" + endpoint + "?" + formData, method.toUpperCase(), null, null, null, null, null, null), $async$Request$3);
              case 6:
              ...
              case 5:
                ...
                $async$temp3 = J;
                $async$goto = 7;
                return P._asyncAwait(W.HttpRequest_request(t2 + "/" + endpoint, method.toUpperCase(), null, null, P.LinkedHashMap__makeLiteral(["Content-Type", "application/x-www-form-urlencoded"]), null, formData, null), $async$Request$3);
              case 7:
                // returning from await.
                $async$temp1.complete$1(0, $async$temp2.decode$1($async$temp3.get$response$x($async$result)));
              case 4:
        ...
        return P._asyncStart($async$Request$3, $async$completer);
      }
    },
    ...
    Api_Request__closure: {
      ...
      call$1: function(elem) {
        this.parts.push(H.S(P._Uri__uriEncode(C.List_nxB, this.key, C.Utf8Codec_false, true)) + "[]=" + H.S(P._Uri__uriEncode(C.List_nxB, elem, C.Utf8Codec_false, true)));
      }
    }
    ...
    EventPage: {
      ...
      EventPage$0: function() {
        ...
        W._EventStreamSubscription$(t1._html$_target, t1._eventType, new X.EventPage_closure(this), false, H.getTypeArgumentByIndex(t1, 0));
      },
      static: {
        EventPage$: function() {
    ...
    EventPage_closure: {
      ...
      call$1: function($event) {
        var $async$goto = 0, $async$completer = P.Completer_Completer$sync(), notifyEmail, t1, t2, t3, $async$temp1, $async$temp2;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                $async$temp2 = J;
                $async$goto = 2;
                return P._asyncAwait(t3.Request$3("notify/subscribe", "POST", P.LinkedHashMap__makeLiteral(["email", t2, "event", t3.Event])), $async$call$1);
              case 2:
                // returning from await.
    ...
    RegisterPage: {
      ...
      doApplyPromo$0: function() {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                t1 = document;
                code = J.trim$0$s(J.get$value$x(t1.querySelector('input[name="promo"]')));
                ...
                t2 = A.api();
                $async$goto = 7;
                return P._asyncAwait(t2.Request$3(C.JSString_methods.$add("register/", t2.Event) + "/promotion", "GET", P.LinkedHashMap__makeLiteral(["code", code])), $async$doApplyPromo$0);
              case 7:
                // returning from await.
              ...
              case 6:
                ...
                $async$self.refreshDisplayedPrice$0();
                $async$self.hidePromoPicker$0();
                t1 = t1.querySelector(".promo.link").style;
                t1.display = "none";
        ...
        return P._asyncStart($async$doApplyPromo$0, $async$completer);
      },
      hidePromoPicker$0: function() {
        var t1, promoPickerElem, promoLinkElem;
        t1 = document;
        promoPickerElem = t1.querySelector(".promo-picker");
        promoLinkElem = t1.querySelector(".promo.link");
        J.set$value$x(t1.querySelector('input[name="promo"]'), "");
      ...
      doPay$0: function() {
          ...
          while (true)
            switch ($async$goto) {
              ...
              case 7:
                ...
                $async$temp1 = t1;
                $async$goto = 13;
                return P._asyncAwait(t3.Register$4$promoCode$quotedPrice$registrations$stripeToken($async$self.promoCode, t5, t4, t2), $async$doPay$0);
              case 13:
                // returning from await.
              ...
              case 12:
                ...
                if (J.$eq$(J.$index$asx(t1.regResponse, "status"), 200)) {
                  ...
                  t6 = t2.querySelector("body");
                  t6.toString;
                  params = P.JsObject_JsObject$jsify(P.LinkedHashMap__makeLiteral(["app_id", t3, "page_id", t4, "ref", t5, "user_ref", t6.getAttribute("data-" + new W._DataAttributeMap(new W._ElementAttributeMap(t6))._toHyphenedName$1("userRef"))]));
                  J.$index$asx(J.$index$asx($.$get$context(), "FB"), "AppEvents").callMethod$2("logEvent", ["MessengerCheckboxUserConfirmation", null, params]);
                  t6 = [null];
                  W._CssStyleDeclarationSet$(new W._FrozenElementList(t2.querySelectorAll(".registration, .payment"), t6))._setAll$2("display", "none");
                  t5 = t2.querySelector("form .success").style;
                  t5.display = "block";
                  t2 = new W._FrozenElementList(t2.querySelectorAll("form .success a.download"), t6);
        ...
        return P._asyncStart($async$doPay$0, $async$completer);
      },
      getRegistrationInputs$1: function(requiredOnly) {
        var elements, t1, t2;
        elements = H.setRuntimeTypeInfo([], [W.InputElement]);
        t1 = document;
        t2 = [null];
        C.JSArray_methods.addAll$1(elements, new W._FrozenElementList(t1.querySelectorAll(".attendee input"), t2));
        if (this.displayedPrice > 0)
          C.JSArray_methods.addAll$1(elements, new W._FrozenElementList(t1.querySelectorAll("#card_number, #exp"), t2));
        if (!requiredOnly)
          elements.push(t1.querySelector('input[name="promo"]'));
        return elements;
      },
      ...
      requestStripeToken$0: function() {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                t1 = document;
                cardNumber = t1.querySelector("#card_number");
                expParts = J.split$1$s(J.get$value$x(t1.querySelector("#exp")), "/");
                expDay = null;
                expYear = null;
                ...
                $async$goto = 7;
                return P._asyncAwait(t1.Request$3("tokens", "POST", P.LinkedHashMap__makeLiteral(["card", P.LinkedHashMap__makeLiteral(["number", t2, "exp_month", J.toString$0$(t3), "exp_year", J.toString$0$(t4)])])), $async$requestStripeToken$0);
              case 7:
                // returning from await.
        ...
        return P._asyncStart($async$requestStripeToken$0, $async$completer);
      },
      addAttendee$0: function() {
        ...
        t1 = document;
        attendeeTemplate = t1.querySelector(".attendee").cloneNode(true);
        fields = J.querySelectorAll$1$x(attendeeTemplate, "input");
        fields.forEach$1(fields, new R.RegisterPage_addAttendee_closure());
        t1.querySelector(".registration").insertBefore(attendeeTemplate, t1.querySelector(".add-attendee"));
        if (t1.querySelectorAll(".registration .attendee").length > 1) {
          t1 = t1.querySelector(".remove-attendee").style;
          t1.display = "inline-block";
        }
      },
      getFilledRegistrations$0: function() {
        return new H.MappedListIterable(new W._FrozenElementList(document.querySelectorAll(".attendee"), [null]), new R.RegisterPage_getFilledRegistrations_closure(), [null, null]);
      },
      refreshDisplayedPrice$0: function() {
        var regCount, t1, subtotal, subtotalLabelElem, subtotalElem, discountContainerElem, discountLabelElem, discountElem, totalElem, t2, cardElem;
        ...
        t1 = document;
        subtotalLabelElem = t1.querySelector(".price .subtotal .label");
        subtotalElem = t1.querySelector(".price .subtotal .amount");
        discountContainerElem = t1.querySelector(".price .discount");
        discountLabelElem = t1.querySelector(".price .discount .label");
        discountElem = t1.querySelector(".price .discount .amount");
        totalElem = t1.querySelector(".price .total .amount");
        ...
        cardElem = t1.querySelector(".card");
        if (this.displayedPrice === 0) {
          t1 = cardElem.style;
          t1.display = "none";
        } else {
      ...
      RegisterPage$0: function() {
        var t1, t2;
        t1 = document;
        t2 = t1.querySelector(".payment");
        t2.toString;
        t2 = P.num_parse(t2.getAttribute("data-" + new W._DataAttributeMap(new W._ElementAttributeMap(t2))._toHyphenedName$1("defaultUnitPrice")), null);
        this.defaultUnitPrice = t2;
        this.unitPrice = t2;
        this.refreshDisplayedPrice$0();
        t2 = t1.querySelector("section.event");
        t2.toString;
        this.remainingCapacity = P.num_parse(t2.getAttribute("data-" + new W._DataAttributeMap(new W._ElementAttributeMap(t2))._toHyphenedName$1("remaining")), null);
        t2 = t1.querySelector(".card");
        t2.toString;
        this.stripe = new B.Stripe("https://api.stripe.com/v1", t2.getAttribute("data-" + new W._DataAttributeMap(new W._ElementAttributeMap(t2))._toHyphenedName$1("stripePk")));
        t2 = J.get$onClick$x(t1.querySelector(".add-attendee"));
        W._EventStreamSubscription$(t2._html$_target, t2._eventType, new R.RegisterPage_closure(this), false, H.getTypeArgumentByIndex(t2, 0));
        t2 = J.get$onClick$x(t1.querySelector(".remove-attendee"));
        W._EventStreamSubscription$(t2._html$_target, t2._eventType, new R.RegisterPage_closure0(this), false, H.getTypeArgumentByIndex(t2, 0));
    ...
    RegisterPage_closure0: {
      ...
      call$1: function($event) {
        ...
        if (t1.formDisabled)
          return;
        t2 = document;
        t3 = t2.querySelectorAll(".registration .attendee");
        t4 = t3.length;
        t5 = t4 - 1;
        if (t5 < 0)
        ...
        if (t4 != null)
          t4.removeChild(t5);
        if (t3.length <= 2) {
          t2 = t2.querySelector(".remove-attendee").style;
          t2.display = "none";
        }
        t1.refreshDisplayedPrice$0();
      }
    ...
    Stripe: {
      "^": "Object;Base,Public",
      Request$3: function(endpoint, method, body) {
        var $async$goto = 0, $async$completer = P.Completer_Completer$sync(), $async$returnValue, $async$self = this, parts, formData, t1, completeNormal, t2;
        var $async$Request$3 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1)
            return P._asyncRethrow($async$result, $async$completer);
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                if (method.toUpperCase() === "GET")
                  W.HttpRequest_request(t2 + "/" + endpoint + "?" + formData, method.toUpperCase(), null, null, null, null, null, null).catchError$1(new B.Stripe_Request_closure1(completeNormal)).then$1(completeNormal);
                else
                  W.HttpRequest_request(t2 + "/" + endpoint, method.toUpperCase(), null, null, P.LinkedHashMap__makeLiteral(["Content-Type", "application/x-www-form-urlencoded"]), null, formData, null).catchError$1(new B.Stripe_Request_closure2(completeNormal)).then$1(completeNormal);
                $async$returnValue = t1;
                // goto return
                $async$goto = 1;
                break;
    ...
    Stripe_Request__closure: {
      ...
      call$2: function(skey, elem) {
        this.parts.push(H.S(P._Uri__uriEncode(C.List_nxB, this.key, C.Utf8Codec_false, true)) + "[" + H.S(P._Uri__uriEncode(C.List_nxB, skey, C.Utf8Codec_false, true)) + "]=" + H.S(P._Uri__uriEncode(C.List_nxB, elem, C.Utf8Codec_false, true)));
      }
    },
