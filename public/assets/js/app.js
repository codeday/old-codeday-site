// Generated by dart2js, the Dart to JavaScript compiler version: 1.13.2.
...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
  ...
  }], ["", "../../../resources/dart/services/api.dart",, A, {
    "^": "",
    api: function() {
      var t1, t2;
      t1 = $._api;
      if (t1 == null) {
        t1 = new A.Api(null, null, null);
        t2 = document.querySelector("body");
        t2.toString;
        t1.Base = t2.getAttribute("data-" + new W._DataAttributeMap(new W._ElementAttributeMap(t2))._toHyphenedName$1("apiBase"));
        t2 = document.querySelector("body");
        t2.toString;
        t1.Public = t2.getAttribute("data-" + new W._DataAttributeMap(new W._ElementAttributeMap(t2))._toHyphenedName$1("apiPublic"));
        t2 = document.querySelector("body");
        t2.toString;
        t1.Event = t2.getAttribute("data-" + new W._DataAttributeMap(new W._ElementAttributeMap(t2))._toHyphenedName$1("event"));
        $._api = t1;
      }
      return t1;
    },
    Api: {
      "^": "Object;Base,Public,Event",
      Register$4$promoCode$quotedPrice$registrations$stripeToken: function(promoCode, quotedPrice, registrations, stripeToken) {
        return this.Request$3(C.JSString_methods.$add("register/", this.Event) + "/register", "POST", P.LinkedHashMap__makeLiteral(["card_token", stripeToken, "quoted_price", quotedPrice, "first_names", H.setRuntimeTypeInfo(new H.MappedListIterable(registrations, new A.Api_Register_closure()), [null, null]), "last_names", H.setRuntimeTypeInfo(new H.MappedListIterable(registrations, new A.Api_Register_closure0()), [null, null]), "emails", H.setRuntimeTypeInfo(new H.MappedListIterable(registrations, new A.Api_Register_closure1()), [null, null]), "code", promoCode]));
      },
      Request$3: function(endpoint, method, body) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, parts, formData, finalResult, t1, $async$temp1, $async$temp2, $async$temp3, $async$temp4, $async$temp5, $async$temp6, $async$temp7;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                $async$temp1.$indexSet(0, "access_token", $async$temp2.Public);
                parts = [];
                $async$temp1 = body;
                $async$temp1 = $async$temp1;
                $async$temp2 = A;
                $async$temp1.forEach$1(0, new $async$temp2.Api_Request_closure(parts));
                $async$temp1 = C;
                $async$temp1 = $async$temp1.JSArray_methods;
                formData = $async$temp1.join$1(parts, "&");
                $async$temp1 = H;
                $async$temp1 = $async$temp1;
                $async$temp2 = P;
                ...
                $async$temp5 = $;
                finalResult = $async$temp1.setRuntimeTypeInfo(new $async$temp2._AsyncCompleter($async$temp3.setRuntimeTypeInfo(new $async$temp4._Future(0, $async$temp5.Zone__current, null), [null])), [null]);
              ...
              case 6:
                // then
                $async$temp1 = t1;
                $async$returnValue = $async$temp1.$add();
                // goto return
                $async$goto = 1;
                break;
              case 7:
                ...
                $async$temp1 = $async$temp1;
                $async$temp2 = C;
                $async$temp2 = $async$temp2.JsonCodec_null_null;
                $async$temp2 = $async$temp2;
                $async$temp3 = J;
                $async$temp3 = $async$temp3;
                $async$temp4 = W;
                $async$goto = 8;
                return P._asyncHelper($async$temp4.HttpRequest_request(t1 + "/" + endpoint + "?" + formData, method.toUpperCase(), null, null, null, null, null, null), $async$Request$3, $async$completer);
              case 8:
                // returning from await.
                $async$temp1.complete$1(0, $async$temp2.decode$1($async$temp3.get$response$x($async$result)));
                // goto join
                $async$goto = 4;
                break;
              case 5:
              ...
              case 10:
                ...
                $async$temp4 = W;
                $async$temp4 = $async$temp4;
                $async$temp5 = t1 + "/" + endpoint;
                $async$temp6 = method.toUpperCase();
                $async$temp7 = P;
                $async$goto = 11;
                return P._asyncHelper($async$temp4.HttpRequest_request($async$temp5, $async$temp6, null, null, $async$temp7.LinkedHashMap__makeLiteral(["Content-Type", "application/x-www-form-urlencoded"]), null, formData, null), $async$Request$3, $async$completer);
              case 11:
                // returning from await.
                $async$temp1.complete$1(0, $async$temp2.decode$1($async$temp3.get$response$x($async$result)));
              case 4:
        ...
        return P._asyncHelper(null, $async$Request$3, $async$completer, null);
      }
    },
    Api_Register_closure: {
      "^": "Closure:0;",
      call$1: [function(r) {
    ...
    Api_Request_closure: {
      ...
      call$2: function(key, value) {
        ...
        if (!!t1.$isIterable) {
          t1.forEach$1(value, new A.Api_Request__closure(this._captured_parts_0, key));
          return;
        }
        if (value == null)
          return;
    ...
    Api_Request__closure: {
      "^": "Closure:0;_captured_parts_1,_captured_key_2",
      call$1: function(elem) {
        this._captured_parts_1.push(P.Uri__uriEncode(C.List_nxB, this._captured_key_2, C.Utf8Codec_false, true) + "[]=" + P.Uri__uriEncode(C.List_nxB, elem, C.Utf8Codec_false, true));
      }
    }
    ...
    }, "call$2", "call$1", "async___nullErrorHandler$closure", 2, 2, 7, 1, 0, 2],
    ...
    _BroadcastStreamController: {
      ...
      }, "addError$1", "call$2", "call$1", "get$addError", 2, 2, 4, 1],
      close$0: function(_) {
        var doneFuture;
        if ((this._state & 4) !== 0)
    ...
    _Completer: {
      ...
      }, "completeError$1", "call$2", "call$1", "get$completeError", 2, 2, 4, 1, 0, 2]
    },
    _AsyncCompleter: {
      "^": "_Completer;future",
      ...
      }, "complete$0", "call$1", "call$0", "get$complete", 0, 2, 16, 1, 11],
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 7, 1, 0, 2],
    ...
    _Future__chainForeignFuture_closure0: {
      ...
      }, "call$1", null, null, null, 2, 2, null, 1, 0, 2, "call"]
    },
    ...
    _StreamIteratorImpl: {
      ...
      }, "_onError$1", "call$2", "call$1", "get$_onError", 2, 2, 4, 1, 0, 2],
      _onDone$0: [function() {
        if (this._state === 2) {
    ...
    _ForwardingStreamSubscription: {
      ...
      }, "call$2", "get$_handleError", 4, 0, 18, 0, 2],
    ...
    _DataAttributeMap_forEach_closure: {
      "^": "Closure:10;_html$_captured_this_0,_html$_captured_f_1",
      call$2: function(key, value) {
    ...
    _DataAttributeMap_keys_closure: {
      "^": "Closure:10;_html$_captured_this_0,_captured_keys_1",
      call$2: function(key, value) {
        var t1 = J.getInterceptor$s(key);
        if (t1.startsWith$1(key, "data-"))
    ...
    }, "call$1", "js___convertToDart$closure", 2, 0, 21, 8],
  ...
  }], ["", "../../../resources/dart/web/pages/event.dart",, X, {
    "^": "",
    EventPage: {
      "^": "Object;",
      EventPage$0: function() {
        var t1 = J.get$onSubmit$x(document.querySelector(".notify-signup"));
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new X.EventPage_closure(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      },
      static: {EventPage$: function() {
    ...
    EventPage_closure: {
      "^": "Closure:20;_event$_captured_this_0",
      call$1: [function($event) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, notifyEmail, t1, t2, t3, $async$temp1, $async$temp2, $async$temp3, $async$temp4, $async$temp5, $async$temp6;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                $async$temp1 = J;
                $async$temp1.preventDefault$0$x($event);
                $async$temp1 = document;
                notifyEmail = $async$temp1.querySelector(".notify-signup input[name=\"email\"]");
                $async$temp1 = J;
                t1 = $async$temp1.getInterceptor$x(notifyEmail);
                $async$temp1 = t1;
                t2 = $async$temp1.get$value(notifyEmail);
                $async$temp1 = A;
                t3 = $async$temp1.api();
                $async$temp1 = J;
                $async$temp1 = $async$temp1;
                ...
                $async$temp6 = t3;
                $async$goto = 5;
                return P._asyncHelper($async$temp3.Request$3("notify/subscribe", "POST", $async$temp4.LinkedHashMap__makeLiteral(["email", $async$temp5, "event", $async$temp6.Event])), $async$call$1, $async$completer);
              case 5:
                // returning from await.
                $async$goto = $async$temp1.$eq$($async$temp2.$index$asx($async$result, "status"), 200) ? 2 : 4;
                break;
              case 2:
                // then
                $async$temp1 = V;
                $async$temp1.swal(null, "We will let you know as soon as registrations open.", "Subscribed!", "success");
                // goto join
                $async$goto = 3;
                break;
              case 4:
                // else
                $async$temp1 = V;
                $async$temp1.swal(null, "Something went wrong when we tried to subscribe you to notifications. You may already be subscribed. Ifnot, please contact support@codeday.org", "Error", "error");
              case 3:
                // join
                $async$temp1 = t1;
                $async$temp1.set$value(notifyEmail, "");
                // implicit return
  ...
  }], ["", "../../../resources/dart/web/main.dart",, F, {
    "^": "",
    main: [function() {
    ...
    RegisterPage: {
      ...
      doApplyPromo$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, code, details, t1, exception, $async$exception, $async$temp1, $async$temp2, $async$temp3, $async$temp4, $async$temp5;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                code = $async$temp1.trim$0$s($async$temp2.get$value$x($async$temp3.querySelector("input[name=\"promo\"]")));
                $async$temp1 = $async$self;
                $async$temp1.promoCode = null;
                $async$temp1 = $async$self;
                $async$temp1.promoRemainingUses = null;
                $async$temp1 = $async$self;
                $async$temp2 = $async$self;
                $async$temp1.unitPrice = $async$temp2.defaultUnitPrice;
                $async$temp1 = $async$self;
                $async$temp1.refreshDisplayedPrice$0();
                $async$temp1 = J;
                $async$goto = $async$temp1.get$length$asx(code) === 0 ? 3 : 4;
                break;
              case 3:
                // then
                $async$temp1 = $async$self;
                $async$temp1.hidePromoPicker$0();
                // goto return
                $async$goto = 1;
                break;
              case 4:
                ...
                $async$temp2 = $async$temp2;
                $async$temp3 = t1;
                $async$temp2 = $async$temp2.$add("register/", $async$temp3.Event) + "/promotion";
                $async$temp3 = P;
                $async$goto = 9;
                return P._asyncHelper($async$temp1.Request$3($async$temp2, "GET", $async$temp3.LinkedHashMap__makeLiteral(["code", code])), $async$doApplyPromo$0, $async$completer);
              case 9:
                // returning from await.
              ...
              case 6:
                ...
                $async$temp2 = C;
                $async$temp2 = $async$temp2.JSString_methods;
                $async$temp1.swal(null, $async$temp2.$add("Sorry, the promo code ", code) + " does not exist.", "Error", "error");
                $async$temp1 = $async$self;
                $async$temp1.hidePromoPicker$0();
                // goto return
                $async$goto = 1;
              ...
              case 8:
                // after finally
                $async$temp1 = J;
                $async$temp1 = $async$temp1.$index$asx(details, "remaining_uses") != null;
                if ($async$temp1) {
                  // goto then
                  $async$goto = 12;
                  break;
              ...
              case 12:
                ...
                $async$temp1 = $async$temp1;
                $async$temp2 = J;
                $async$result = $async$temp1.$eq$($async$temp2.$index$asx(details, "remaining_uses"), 0);
              case 13:
                // join
                $async$goto = $async$result ? 10 : 11;
                break;
              case 10:
                // then
                $async$temp1 = V;
                ...
                $async$temp2 = C;
                $async$temp2 = $async$temp2.JSString_methods;
                $async$temp1.swal(null, $async$temp2.$add("Sorry, ", code) + " has already been used.", "Error", "error");
                $async$temp1 = $async$self;
                $async$temp1.hidePromoPicker$0();
                // goto return
                $async$goto = 1;
              ...
              case 16:
                ...
                $async$temp1 = $async$temp1;
                $async$temp2 = J;
                $async$temp2 = $async$temp2.$index$asx(details, "remaining_uses");
                $async$temp3 = J;
                $async$temp3 = $async$temp3;
                $async$temp4 = $async$self;
                $async$temp4 = $async$temp4.getFilledRegistrations$0();
                $async$result = $async$temp1.$lt$n($async$temp2, $async$temp3.get$length$asx($async$temp4.__internal$_source));
              case 17:
                // join
                $async$goto = $async$result ? 14 : 15;
                break;
              case 14:
                // then
                $async$temp1 = V;
                ...
                $async$temp2 = $async$temp2;
                $async$temp3 = C;
                $async$temp3 = $async$temp3.JSString_methods;
                $async$temp3 = $async$temp3.$add("The code ", code) + " only allows ";
                $async$temp4 = J;
                $async$temp4 = $async$temp4;
                $async$temp5 = J;
                $async$temp2 = $async$temp2.$add($async$temp3, $async$temp4.toString$0$($async$temp5.$index$asx(details, "remaining_uses"))) + " uses, but you have ";
                $async$temp3 = C;
                $async$temp3 = $async$temp3.JSInt_methods;
                $async$temp3 = $async$temp3;
                $async$temp4 = J;
                $async$temp4 = $async$temp4;
                $async$temp5 = $async$self;
                $async$temp5 = $async$temp5.getFilledRegistrations$0();
                $async$temp1.swal(null, $async$temp2 + $async$temp3.toString$0($async$temp4.get$length$asx($async$temp5.__internal$_source)) + " tickets in your cart. Please remove some tickets to use this promo (you can order them without a code in a separate order).", "Error", "error");
                // goto return
                $async$goto = 1;
                break;
              case 15:
                // join
                $async$temp1 = J;
                $async$goto = $async$temp1.$index$asx(details, "expired") === true ? 18 : 19;
                break;
              case 18:
                // then
                $async$temp1 = V;
                ...
                $async$temp2 = C;
                $async$temp2 = $async$temp2.JSString_methods;
                $async$temp1.swal(null, $async$temp2.$add("Sorry, the promo code ", code) + " is expired.", "Error", "error");
                $async$temp1 = $async$self;
                $async$temp1.hidePromoPicker$0();
                // goto return
                $async$goto = 1;
              ...
              case 19:
                // join
                $async$temp1 = $async$self;
                $async$temp1.promoCode = code;
                $async$temp1 = $async$self;
                $async$temp2 = J;
                $async$temp1.promoRemainingUses = $async$temp2.$index$asx(details, "remaining_uses");
                $async$temp1 = $async$self;
                $async$temp2 = J;
                $async$temp1.unitPrice = $async$temp2.$index$asx(details, "cost");
                $async$temp1 = $async$self;
                $async$temp1.refreshDisplayedPrice$0();
                $async$temp1 = $async$self;
                $async$temp1.hidePromoPicker$0();
                $async$temp1 = document;
                $async$temp1 = $async$temp1.querySelector(".promo.link");
                t1 = $async$temp1.style;
                $async$temp1 = t1;
                $async$temp1.display = "none";
                $async$temp1 = J;
                $async$temp1 = $async$temp1;
                $async$temp2 = J;
                $async$temp2 = $async$temp2;
                $async$temp3 = J;
                t1 = $async$temp1.$add$ns($async$temp2.toString$0$($async$temp3.$index$asx(details, "discount")), "% off!");
                $async$temp1 = V;
                $async$temp1 = $async$temp1;
                $async$temp2 = C;
                $async$temp2 = $async$temp2.JSString_methods;
                $async$temp2 = $async$temp2.$add("We've successfully applied the promo code ", code) + ". Your new total is $";
                $async$temp3 = C;
                $async$temp3 = $async$temp3.JSNumber_methods;
                $async$temp3 = $async$temp3;
                $async$temp4 = $async$self;
                $async$temp1.swal("/assets/img/thumbsup.jpg", $async$temp2 + $async$temp3.toStringAsFixed$1($async$temp4.displayedPrice, 2) + ".", t1, null);
              case 1:
                // return
                return P._asyncHelper($async$returnValue, 0, $async$completer, null);
              case 2:
        ...
        return P._asyncHelper(null, $async$doApplyPromo$0, $async$completer, null);
      },
      hidePromoPicker$0: function() {
        var promoPickerElem, promoLinkElem, t1;
        promoPickerElem = document.querySelector(".promo-picker");
        promoLinkElem = document.querySelector(".promo.link");
        J.set$value$x(document.querySelector("input[name=\"promo\"]"), "");
      ...
      doPay$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, t1, stripeToken, regResponse, tokenResponse, t2, t3, exception, $async$exception, $async$temp1, $async$temp2, $async$temp3, $async$temp4;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                t1 = {};
                $async$temp1 = $async$self;
                $async$temp1.disableForm$0();
                $async$temp1 = t1;
                $async$temp1._captured_complete_0 = true;
                $async$temp1 = C;
                $async$temp1 = $async$temp1.JSArray_methods;
                $async$temp1 = $async$temp1;
                $async$temp2 = $async$self;
                $async$temp2 = $async$temp2.getRegistrationInputs$1(true);
                $async$temp3 = R;
                $async$temp1.forEach$1($async$temp2, new $async$temp3.RegisterPage_doPay_closure(t1));
                $async$temp1 = t1;
                $async$goto = !$async$temp1._captured_complete_0 ? 3 : 4;
                break;
              case 3:
                // then
                $async$temp1 = V;
                $async$goto = 5;
                return P._asyncHelper($async$temp1.swal(null, "Please complete all fields.", "Error", "error"), $async$doPay$0, $async$completer);
              case 5:
                // returning from await.
                $async$temp1 = $async$self;
                $async$temp1.enableForm$0();
                // goto return
                $async$goto = 1;
                break;
              case 4:
                ...
                stripeToken = null;
                $async$temp1 = $async$self;
                $async$goto = $async$temp1.displayedPrice > 0 ? 6 : 7;
                break;
              case 6:
                // then
                $async$temp1 = $async$self;
                $async$goto = 8;
                return P._asyncHelper($async$temp1.requestStripeToken$0(), $async$doPay$0, $async$completer);
              case 8:
                // returning from await.
                tokenResponse = $async$result;
                $async$temp1 = J;
                t1 = $async$temp1.getInterceptor$asx(tokenResponse);
                $async$temp1 = J;
                $async$temp1 = $async$temp1;
                $async$temp2 = t1;
                $async$goto = !$async$temp1.$eq$($async$temp2.$index(tokenResponse, "status"), 200) ? 9 : 10;
                break;
              case 9:
                // then
                $async$temp1 = V;
                ...
                $async$temp3 = $async$temp3;
                $async$temp4 = t1;
                $async$temp1.swal(null, $async$temp2.$index$asx($async$temp3.$index$asx($async$temp4.$index(tokenResponse, "response"), "error"), "message"), "Error", "error");
                $async$temp1 = $async$self;
                $async$temp1.enableForm$0();
                // goto return
                $async$goto = 1;
              ...
              case 10:
                ...
                $async$temp1 = $async$temp1;
                $async$temp2 = t1;
                stripeToken = $async$temp1.$index$asx($async$temp2.$index(tokenResponse, "response"), "id");
              case 7:
                // join
                regResponse = null;
                $async$handler = 12;
                ...
                t1 = $async$temp1.api();
                $async$temp1 = $async$self;
                t2 = $async$temp1.getFilledRegistrations$0();
                $async$temp1 = $async$self;
                t3 = $async$temp1.displayedPrice;
                $async$temp1 = t1;
                $async$temp1 = $async$temp1;
                $async$temp2 = $async$self;
                $async$goto = 15;
                return P._asyncHelper($async$temp1.Register$4$promoCode$quotedPrice$registrations$stripeToken($async$temp2.promoCode, t3, t2, stripeToken), $async$doPay$0, $async$completer);
              case 15:
                // returning from await.
              ...
              case 12:
                ...
                $async$temp1.unwrapException($async$exception);
                $async$temp1 = V;
                $async$temp1.swal(null, "Something went wrong with our payment processor. Please contact support@codeday.org", "Error", "error");
                // goto after finally
                $async$goto = 14;
                break;
              case 11:
              ...
              case 14:
                ...
                $async$temp1 = $async$temp1;
                $async$temp2 = J;
                $async$goto = $async$temp1.$eq$($async$temp2.$index$asx(regResponse, "status"), 200) ? 16 : 18;
                break;
              case 16:
                // then
                $async$temp1 = V;
                $async$temp1.swal(null, "You have successfully registered for CodeDay! A receipt has been emailed to all ticket holders. You will NOT receive a ticket -- we will check you in by name at the door.", "You're in!", "success");
                $async$temp1 = W;
                $async$temp1 = $async$temp1;
                $async$temp2 = W;
                $async$temp2 = $async$temp2;
                $async$temp3 = document;
                $async$temp1 = $async$temp1._CssStyleDeclarationSet$(new $async$temp2._FrozenElementList($async$temp3.querySelectorAll(".registration, .payment")));
                $async$temp1._setAll$2("display", "none");
                $async$temp1 = document;
                $async$temp1 = $async$temp1.querySelector("form .success");
                t1 = $async$temp1.style;
                $async$temp1 = t1;
                $async$temp1.display = "block";
                // goto join
                $async$goto = 17;
                break;
              case 18:
                ...
                $async$temp1 = $async$temp1;
                $async$temp2 = J;
                $async$temp1.swal(null, $async$temp2.$index$asx(regResponse, "message"), "Error", "error");
                $async$temp1 = $async$self;
                $async$temp1.enableForm$0();
                // goto return
                $async$goto = 1;
        ...
        return P._asyncHelper(null, $async$doPay$0, $async$completer, null);
      },
      getRegistrationInputs$1: function(requiredOnly) {
        var elements = H.setRuntimeTypeInfo([], [W.InputElement]);
        C.JSArray_methods.addAll$1(elements, new W._FrozenElementList(document.querySelectorAll(".attendee input")));
        if (this.displayedPrice > 0)
          C.JSArray_methods.addAll$1(elements, new W._FrozenElementList(document.querySelectorAll("#card_number, #exp")));
        if (!requiredOnly)
          elements.push(document.querySelector("input[name=\"promo\"]"));
        return elements;
      },
      ...
      requestStripeToken$0: function() {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                $async$temp4 = $async$temp4;
                $async$temp5 = $;
                completer = $async$temp1.setRuntimeTypeInfo(new $async$temp2._AsyncCompleter($async$temp3.setRuntimeTypeInfo(new $async$temp4._Future(0, $async$temp5.Zone__current, null), [null])), [null]);
                $async$temp1 = document;
                cardNumber = $async$temp1.querySelector("#card_number");
                $async$temp1 = J;
                $async$temp1 = $async$temp1;
                $async$temp2 = J;
                $async$temp2 = $async$temp2;
                $async$temp3 = document;
                expParts = $async$temp1.split$1$s($async$temp2.get$value$x($async$temp3.querySelector("#exp")), "/");
                expDay = null;
                expYear = null;
                $async$goto = 0 >= expParts.length ? 3 : 4;
                break;
              case 3:
                // then
                $async$temp1 = H;
                $async$returnValue = $async$temp1.ioore(expParts, 0);
                // goto return
                $async$goto = 1;
                break;
              case 4:
                ...
                $async$temp1 = $async$temp1;
                $async$temp2 = J;
                expDay = $async$temp1.Primitives_parseInt($async$temp2.trim$0$s(expParts[0]), null, null);
                $async$goto = 1 >= expParts.length ? 5 : 6;
                break;
              case 5:
                // then
                $async$temp1 = H;
                $async$returnValue = $async$temp1.ioore(expParts, 1);
                // goto return
                $async$goto = 1;
                break;
              case 6:
                ...
                $async$temp1 = $async$temp1;
                $async$temp2 = J;
                expYear = $async$temp1.Primitives_parseInt($async$temp2.trim$0$s(expParts[1]), null, null);
                $async$handler = 8;
                $async$temp1 = $async$self;
                t1 = $async$temp1.stripe;
                $async$temp1 = J;
                t2 = $async$temp1.get$value$x(cardNumber);
                t1.toString;
                $async$temp1 = J;
                $async$temp1 = $async$temp1;
                ...
                $async$temp6 = t2;
                $async$temp7 = J;
                $async$temp7 = $async$temp7.toString$0$(expDay);
                $async$temp8 = J;
                $async$goto = 11;
                return P._asyncHelper($async$temp3.Request$3("tokens", "POST", $async$temp4.LinkedHashMap__makeLiteral(["card", $async$temp5.LinkedHashMap__makeLiteral(["number", $async$temp6, "exp_month", $async$temp7, "exp_year", $async$temp8.toString$0$(expYear)])])), $async$requestStripeToken$0, $async$completer);
              case 11:
                // returning from await.
                $async$temp1.complete$1$x($async$temp2, $async$result);
                $async$handler = 2;
                // goto after finally
                $async$goto = 10;
                break;
              case 8:
                ...
                $async$temp1.unwrapException($async$exception);
                $async$temp1 = H;
                $async$temp1.getTraceFromException($async$exception);
                $async$temp1 = J;
                $async$temp1 = $async$temp1;
                $async$temp2 = completer;
                $async$temp3 = P;
                ...
                $async$temp4 = $async$temp4;
                $async$temp5 = P;
                $async$temp1.complete$1$x($async$temp2, $async$temp3.LinkedHashMap__makeLiteral(["status", 402, "response", $async$temp4.LinkedHashMap__makeLiteral(["error", $async$temp5.LinkedHashMap__makeLiteral(["type", "card_error", "code", "invalid", "message", "Your card's information is invalid."])])]));
                // goto after finally
                $async$goto = 10;
                break;
              case 7:
              ...
              case 10:
                // after finally
                $async$temp1 = completer;
                $async$returnValue = $async$temp1.get$future();
                // goto return
                $async$goto = 1;
                break;
              case 1:
        ...
        return P._asyncHelper(null, $async$requestStripeToken$0, $async$completer, null);
      },
      addAttendee$0: function() {
        var t1, t2, attendeeTemplate, fields;
        if (this.promoRemainingUses != null && J.get$length$asx(this.getFilledRegistrations$0().__internal$_source) === this.promoRemainingUses) {
          V.swal(null, C.JSString_methods.$add(C.JSString_methods.$add("The promotion ", this.promoCode) + " only has ", J.toString$0$(this.promoRemainingUses)) + " uses remaining. If you want to register additional users without this code, you will need to submit two orders.", "Error", "error");
          return;
        }
        t1 = J.get$length$asx(this.getFilledRegistrations$0().__internal$_source);
        ...
        attendeeTemplate = document.querySelector(".attendee").cloneNode(true);
        fields = J.querySelectorAll$1$x(attendeeTemplate, "input");
        fields.forEach$1(fields, new R.RegisterPage_addAttendee_closure());
        document.querySelector(".registration").insertBefore(attendeeTemplate, document.querySelector(".add-attendee"));
        if (document.querySelectorAll(".registration .attendee").length > 1) {
          t1 = document.querySelector(".remove-attendee").style;
          t1.display = "inline-block";
        }
      },
      getFilledRegistrations$0: function() {
        var attendees = new W._FrozenElementList(document.querySelectorAll(".attendee"));
        return attendees.map$1(attendees, new R.RegisterPage_getFilledRegistrations_closure());
      },
      refreshDisplayedPrice$0: function() {
        var regCount, t1, subtotal, subtotalLabelElem, subtotalElem, discountContainerElem, discountLabelElem, discountElem, totalElem, cardElem;
        regCount = J.get$length$asx(this.getFilledRegistrations$0().__internal$_source);
        ...
        if (typeof t1 !== "number")
          return H.iae(t1);
        this.displayedPrice = regCount * t1;
        subtotalLabelElem = document.querySelector(".price .subtotal .label");
        subtotalElem = document.querySelector(".price .subtotal .amount");
        discountContainerElem = document.querySelector(".price .discount");
        discountLabelElem = document.querySelector(".price .discount .label");
        discountElem = document.querySelector(".price .discount .amount");
        totalElem = document.querySelector(".price .total .amount");
        ...
        t1 = this.promoCode;
        if (t1 != null) {
          discountLabelElem.textContent = C.JSString_methods.$add("Discount - \"", t1) + "\"";
        ...
        totalElem.textContent = C.JSNumber_methods.toStringAsFixed$1(this.displayedPrice, 2);
      ...
      RegisterPage$0: function() {
        var t1 = document.querySelector(".payment");
        t1.toString;
        t1 = P.num_parse(t1.getAttribute("data-" + new W._DataAttributeMap(new W._ElementAttributeMap(t1))._toHyphenedName$1("defaultUnitPrice")), null);
        this.defaultUnitPrice = t1;
        this.unitPrice = t1;
        this.refreshDisplayedPrice$0();
        t1 = document.querySelector("section.event");
        t1.toString;
        this.remainingCapacity = P.num_parse(t1.getAttribute("data-" + new W._DataAttributeMap(new W._ElementAttributeMap(t1))._toHyphenedName$1("remaining")), null);
        t1 = document.querySelector(".card");
        t1.toString;
        this.stripe = new B.Stripe("https://api.stripe.com/v1", t1.getAttribute("data-" + new W._DataAttributeMap(new W._ElementAttributeMap(t1))._toHyphenedName$1("stripePk")));
        t1 = J.get$onClick$x(document.querySelector(".add-attendee"));
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.RegisterPage_closure(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = J.get$onClick$x(document.querySelector(".remove-attendee"));
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.RegisterPage_closure0(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        H.setRuntimeTypeInfo(new W._ElementListEventStreamImpl(new W._FrozenElementList(document.querySelectorAll(".promo.link, .price .discount .label")), false, "click"), [null]).listen$1(new R.RegisterPage_closure1(this));
        t1 = J.get$onClick$x(document.querySelector(".promo-picker button"));
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.RegisterPage_closure2(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = J.get$onSubmit$x(document.querySelector("form"));
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.RegisterPage_closure3(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      },
      static: {RegisterPage$: function() {
          var t1 = new R.RegisterPage(null, null, 10, 10, 0, 100, false, null, null);
          t1.RegisterPage$0();
          return t1;
        }}
    },
    RegisterPage_closure: {
      "^": "Closure:0;_register$_captured_this_0",
      call$1: [function($event) {
        var t1 = this._register$_captured_this_0;
        if (t1.formDisabled)
          return;
        t1.addAttendee$0();
    ...
    RegisterPage_closure0: {
      "^": "Closure:0;_register$_captured_this_1",
      call$1: [function($event) {
        var t1, t2, t3, t4;
        t1 = this._register$_captured_this_1;
        if (t1.formDisabled)
          return;
        t2 = document.querySelectorAll(".registration .attendee");
        t3 = t2.length;
        t4 = t3 - 1;
        if (t4 < 0)
          return H.ioore(t2, t4);
        ...
        if (t3 != null)
          t3.removeChild(t4);
        if (t2.length <= 2) {
          t2 = document.querySelector(".remove-attendee").style;
          t2.display = "none";
        }
        t1.refreshDisplayedPrice$0();
      }, null, null, 2, 0, null, 3, "call"]
    },
    RegisterPage_closure1: {
      "^": "Closure:0;_register$_captured_this_2",
      call$1: [function($event) {
        var promoPickerElem, promoLinkElem, t1;
        if (this._register$_captured_this_2.formDisabled)
          return;
        promoPickerElem = document.querySelector(".promo-picker");
        promoLinkElem = document.querySelector(".promo.link");
        t1 = promoPickerElem.style;
    ...
    RegisterPage_doPay_closure: {
      "^": "Closure:0;_register$_box_0",
      call$1: function(elem) {
        var t1 = J.getInterceptor$x(elem);
        if (J.trim$0$s(t1.get$value(elem)).length < 1 || t1.checkValidity$0(elem) !== true)
          this._register$_box_0._captured_complete_0 = false;
      }
    },
    RegisterPage_disableForm_closure: {
      "^": "Closure:0;",
      call$1: function(elem) {
        J.set$disabled$x(elem, true);
        return true;
      }
    },
    RegisterPage_enableForm_closure: {
      "^": "Closure:0;",
      call$1: function(elem) {
        J.set$disabled$x(elem, false);
        return false;
      }
    },
    RegisterPage_addAttendee_closure: {
      "^": "Closure:0;",
      call$1: function(InputElement) {
        J.set$value$x(InputElement, "");
        return "";
      }
    },
    RegisterPage_getFilledRegistrations_closure: {
      "^": "Closure:0;",
      call$1: [function(a) {
        var t1, fnElem, lnElem, emElem;
        t1 = J.getInterceptor$x(a);
        fnElem = t1.querySelector$1(a, "input[name=\"first_name\"]");
        lnElem = t1.querySelector$1(a, "input[name=\"last_name\"]");
        emElem = t1.querySelector$1(a, "input[name=\"email\"]");
        return new T.Registration(J.get$value$x(fnElem), J.get$value$x(lnElem), J.get$value$x(emElem));
      }, null, null, 2, 0, null, 30, "call"]
    }
  }], ["", "../../../resources/dart/models/registration.dart",, T, {
    "^": "",
    Registration: {
      "^": "Object;FirstName<,LastName<,Email<"
    }
  }], ["", "../../../resources/dart/services/stripe.dart",, B, {
    "^": "",
    Stripe: {
      "^": "Object;Base,Public",
      Request$3: function(endpoint, method, body) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, parts, formData, finalResult, completeNormal, t1, $async$temp1, $async$temp2, $async$temp3, $async$temp4, $async$temp5;
        var $async$Request$3 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                $async$temp1 = $async$temp1;
                $async$temp2 = $async$self;
                $async$temp1.$indexSet(0, "key", $async$temp2.Public);
                $async$temp1 = body;
                $async$temp1.$indexSet(0, "payment_user_agent", "stripe.js/c180728");
                parts = [];
                $async$temp1 = body;
                $async$temp1 = $async$temp1;
                $async$temp2 = B;
                $async$temp1.forEach$1(0, new $async$temp2.Stripe_Request_closure(parts));
                $async$temp1 = C;
                $async$temp1 = $async$temp1.JSArray_methods;
                formData = $async$temp1.join$1(parts, "&");
                $async$temp1 = H;
                ...
                finalResult = $async$temp1.setRuntimeTypeInfo(new $async$temp2._AsyncCompleter($async$temp3.setRuntimeTypeInfo(new $async$temp4._Future(0, $async$temp5.Zone__current, null), [null])), [null]);
                $async$temp1 = B;
                completeNormal = new $async$temp1.Stripe_Request_closure0(finalResult);
                $async$temp1 = $async$self;
                t1 = $async$temp1.Base;
                $async$goto = method.toUpperCase() === "GET" ? 3 : 5;
                break;
              case 3:
                // then
                $async$temp1 = W;
                $async$temp1 = $async$temp1.HttpRequest_request(t1 + "/" + endpoint + "?" + formData, method.toUpperCase(), null, null, null, null, null, null);
                $async$temp1 = $async$temp1;
                $async$temp2 = B;
                $async$temp1 = $async$temp1.catchError$1(new $async$temp2.Stripe_Request_closure1(completeNormal));
                $async$temp1.then$1(completeNormal);
                // goto join
                $async$goto = 4;
                break;
              case 5:
                ...
                $async$temp1 = W;
                $async$temp1 = $async$temp1;
                $async$temp2 = t1 + "/" + endpoint;
                $async$temp3 = method.toUpperCase();
                $async$temp4 = P;
                $async$temp1 = $async$temp1.HttpRequest_request($async$temp2, $async$temp3, null, null, $async$temp4.LinkedHashMap__makeLiteral(["Content-Type", "application/x-www-form-urlencoded"]), null, formData, null);
                $async$temp1 = $async$temp1;
                $async$temp2 = B;
                $async$temp1 = $async$temp1.catchError$1(new $async$temp2.Stripe_Request_closure2(completeNormal));
                $async$temp1.then$1(completeNormal);
              case 4:
                // join
                $async$temp1 = finalResult;
    ...
    Stripe_Request_closure: {
      "^": "Closure:3;_stripe$_captured_parts_0",
      call$2: function(key, value) {
        var t1 = J.getInterceptor(value);
        if (!!t1.$isMap) {
          t1.forEach$1(value, new B.Stripe_Request__closure(this._stripe$_captured_parts_0, key));
          return;
        }
        if (!!t1.$isIterable) {
          t1.forEach$1(value, new B.Stripe_Request__closure0(this._stripe$_captured_parts_0, key));
          return;
        }
        if (value == null)
          return;
        if (typeof value === "number" || typeof value === "number" && Math.floor(value) === value)
          value = t1.toString$0(value);
        this._stripe$_captured_parts_0.push(P.Uri__uriEncode(C.List_nxB, key, C.Utf8Codec_false, true) + "=" + P.Uri__uriEncode(C.List_nxB, value, C.Utf8Codec_false, true));
      }
    },
    Stripe_Request__closure: {
      "^": "Closure:3;_stripe$_captured_parts_1,_stripe$_captured_key_2",
      call$2: function(skey, elem) {
        this._stripe$_captured_parts_1.push(P.Uri__uriEncode(C.List_nxB, this._stripe$_captured_key_2, C.Utf8Codec_false, true) + "[" + P.Uri__uriEncode(C.List_nxB, skey, C.Utf8Codec_false, true) + "]=" + P.Uri__uriEncode(C.List_nxB, elem, C.Utf8Codec_false, true));
      }
    },
    Stripe_Request__closure0: {
      "^": "Closure:0;_captured_parts_3,_captured_key_4",
      call$1: function(elem) {
        this._captured_parts_3.push(P.Uri__uriEncode(C.List_nxB, this._captured_key_4, C.Utf8Codec_false, true) + "[]=" + P.Uri__uriEncode(C.List_nxB, elem, C.Utf8Codec_false, true));
      }
    },
    Stripe_Request_closure0: {
      "^": "Closure:0;_captured_finalResult_5",
      call$1: [function(response) {
        var t1;
        if (response == null || J.get$response$x(response) == null)
          return;
        t1 = J.getInterceptor$x(response);
        this._captured_finalResult_5.complete$1(0, P.LinkedHashMap__makeLiteral(["status", t1.get$status(response), "response", C.JsonCodec_null_null.decode$1(t1.get$response(response))]));
      }, null, null, 2, 0, null, 31, "call"]
    },
    Stripe_Request_closure1: {
      "^": "Closure:0;_captured_completeNormal_6",
      call$1: [function(error) {
        return this._captured_completeNormal_6.call$1(J.get$target$x(error));
      }, null, null, 2, 0, null, 0, "call"]
    },
    Stripe_Request_closure2: {
      "^": "Closure:0;_captured_completeNormal_7",
      call$1: [function(error) {
        return this._captured_completeNormal_7.call$1(J.get$target$x(error));
      }, null, null, 2, 0, null, 0, "call"]
    }
  }], ["", "../../../resources/dart/services/swal.dart",, V, {
    "^": "",
    swal: function(imageUrl, text, title, type) {
      var onClose, t1, t2;
      onClose = H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null])), [null]);
      t1 = $.$get$context();
      t2 = P.LinkedHashMap__makeLiteral(["title", title, "text", text, "type", type, "imageUrl", imageUrl]);
      t1.callMethod$2("swal", [P._wrapToDart(P.JsObject__convertDataTree(t2)), onClose.get$complete(onClose)]);
...
;
  ...
  $ = new Isolate();
  init.metadata = ["error", null, "stackTrace", "event", "result", "data", "e", "r", "o", "x", "_", "value", "object", "sender", "closure", "isolate", "numberOfArguments", "arg1", "arg2", "arg3", "arg4", "each", "errorCode", "ignored", "element", "arg", "callback", "captureThis", "self", "arguments", "a", "response"];
  init.types = [{func: 1, args: [,]}, {func: 1}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, args: [P.String, P.String]}, {func: 1, args: [P.String,,]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [P.$int,,]}, {func: 1, v: true, opt: [,]}, {func: 1, ret: P.bool}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [P.Symbol,,]}, {func: 1, ret: P.Future, args: [,]}, {func: 1, ret: P.Object, args: [,]}];
