// Generated by dart2js, the Dart to JavaScript compiler version: 1.16.1.
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    Api: {
      ...
      Register$4$promoCode$quotedPrice$registrations$stripeToken: function(promoCode, quotedPrice, registrations, stripeToken) {
        return this.Request$3(C.JSString_methods.$add("register/", this.Event) + "/register", "POST", P.LinkedHashMap__makeLiteral(["card_token", stripeToken, "quoted_price", quotedPrice, "first_names", H.setRuntimeTypeInfo(new H.MappedListIterable(registrations, new A.Api_Register_closure()), [H.getRuntimeTypeArgument(registrations, "ListIterable", 0), null]), "last_names", H.setRuntimeTypeInfo(new H.MappedListIterable(registrations, new A.Api_Register_closure0()), [H.getRuntimeTypeArgument(registrations, "ListIterable", 0), null]), "emails", H.setRuntimeTypeInfo(new H.MappedListIterable(registrations, new A.Api_Register_closure1()), [H.getRuntimeTypeArgument(registrations, "ListIterable", 0), null]), "code", promoCode]));
      },
      Request$3: function(endpoint, method, body) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, parts, formData, finalResult, t1, $async$temp1, $async$temp2, $async$temp3;
        var $async$Request$3 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                body.$indexSet(0, "access_token", $async$self.Public);
                parts = [];
                body.forEach$1(0, new A.Api_Request_closure(parts));
                formData = C.JSArray_methods.join$1(parts, "&");
                finalResult = H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null])), [null]);
                t1 = $async$self.Base;
              ...
              case 3:
                ...
                $async$temp3 = J;
                $async$goto = 6;
                return P._asyncHelper(W.HttpRequest_request(t1 + "/" + endpoint + "?" + formData, method.toUpperCase(), null, null, null, null, null, null), $async$Request$3, $async$completer);
              case 6:
              ...
              case 5:
                ...
                $async$temp3 = J;
                $async$goto = 7;
                return P._asyncHelper(W.HttpRequest_request(t1 + "/" + endpoint, method.toUpperCase(), null, null, P.LinkedHashMap__makeLiteral(["Content-Type", "application/x-www-form-urlencoded"]), null, formData, null), $async$Request$3, $async$completer);
              case 7:
                // returning from await.
                $async$temp1.complete$1(0, $async$temp2.decode$1($async$temp3.get$response$x($async$result)));
              case 4:
                // join
                $async$returnValue = finalResult.future;
                // goto return
                $async$goto = 1;
                break;
              case 1:
    ...
    Api_Request__closure: {
      ...
      call$1: function(elem) {
        this.parts.push(H.S(P.Uri__uriEncode(C.List_nxB, this.key, C.Utf8Codec_false, true)) + "[]=" + H.S(P.Uri__uriEncode(C.List_nxB, elem, C.Utf8Codec_false, true)));
      }
    }
    ...
    _AsyncCompleter: {
      ...
      }, "complete$0", "call$1", "call$0", "get$complete", 0, 2, 15, 1, 11],
    ...
    _ForwardingStreamSubscription: {
      ...
      }, "call$2", "get$_handleError", 4, 0, 17, 0, 2],
    ...
    }, "call$1", "js___convertToDart$closure", 2, 0, 20, 9],
    ...
    EventPage_closure: {
      ...
      call$1: [function($event) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$handler = 1, $async$currentError, notifyEmail, t1, t2, t3, $async$temp1, $async$temp2;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                notifyEmail = document.querySelector('.notify-signup input[name="email"]');
                t1 = J.getInterceptor$x(notifyEmail);
                t2 = t1.get$value(notifyEmail);
                t3 = A.api();
                $async$temp1 = J;
                $async$temp2 = J;
                $async$goto = 2;
                return P._asyncHelper(t3.Request$3("notify/subscribe", "POST", P.LinkedHashMap__makeLiteral(["email", t2, "event", t3.Event])), $async$call$1, $async$completer);
              case 2:
                // returning from await.
    ...
    RegisterPage: {
      ...
      doApplyPromo$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, code, details, t1, exception, $async$exception;
        var $async$doApplyPromo$0 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                // Function start
                code = J.trim$0$s(J.get$value$x(document.querySelector('input[name="promo"]')));
                ...
                t1 = A.api();
                $async$goto = 7;
                return P._asyncHelper(t1.Request$3(C.JSString_methods.$add("register/", t1.Event) + "/promotion", "GET", P.LinkedHashMap__makeLiteral(["code", code])), $async$doApplyPromo$0, $async$completer);
              case 7:
                // returning from await.
              ...
              case 6:
                ...
                if (J.$index$asx(details, "remaining_uses") != null && J.$eq$(J.$index$asx(details, "remaining_uses"), 0)) {
                  ...
                  ;
                if (J.$index$asx(details, "remaining_uses") != null && J.$lt$n(J.$index$asx(details, "remaining_uses"), J.get$length$asx($async$self.getFilledRegistrations$0()._source))) {
                  V.swal(null, C.JSString_methods.$add(C.JSString_methods.$add("The code ", code) + " only allows ", J.toString$0$(J.$index$asx(details, "remaining_uses"))) + " uses, but you have " + C.JSInt_methods.toString$0(J.get$length$asx($async$self.getFilledRegistrations$0()._source)) + " tickets in your cart. Please remove some tickets to use this promo (you can order them without a code in a separate order).", "Error", "error");
                  // goto return
                  $async$goto = 1;
                  break;
                } else
                  ;
                if (J.$index$asx(details, "expired") === true) {
                  ...
                  ;
                $async$self.promoCode = code;
                $async$self.promoRemainingUses = J.$index$asx(details, "remaining_uses");
                $async$self.unitPrice = J.$index$asx(details, "cost");
                $async$self.refreshDisplayedPrice$0();
                $async$self.hidePromoPicker$0();
                t1 = document.querySelector(".promo.link").style;
                t1.display = "none";
                t1 = J.$add$ns(J.toString$0$(J.$index$asx(details, "discount")), "% off!");
      ...
      doPay$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, t1, stripeToken, tokenResponse, t2, t3, t4, exception, $async$exception, $async$temp1;
          ...
          while (true)
            switch ($async$goto) {
              ...
              case 3:
                // then
                $async$goto = 5;
                return P._asyncHelper(V.swal(null, "Please complete all fields.", "Error", "error"), $async$doPay$0, $async$completer);
              case 5:
                // returning from await.
              ...
              case 6:
                // then
                $async$goto = 8;
                return P._asyncHelper($async$self.requestStripeToken$0(), $async$doPay$0, $async$completer);
              case 8:
                // returning from await.
                tokenResponse = $async$result;
                t2 = J.getInterceptor$asx(tokenResponse);
                if (!J.$eq$(t2.$index(tokenResponse, "status"), 200)) {
                  V.swal(null, J.$index$asx(J.$index$asx(t2.$index(tokenResponse, "response"), "error"), "message"), "Error", "error");
                  $async$self.enableForm$0();
                  // goto return
                  $async$goto = 1;
                  break;
              ...
              case 7:
                ...
                $async$handler = 10;
                t2 = A.api();
                t3 = $async$self.getFilledRegistrations$0();
                t4 = $async$self.displayedPrice;
                $async$temp1 = t1;
                $async$goto = 13;
                return P._asyncHelper(t2.Register$4$promoCode$quotedPrice$registrations$stripeToken($async$self.promoCode, t4, t3, stripeToken), $async$doPay$0, $async$completer);
              case 13:
                // returning from await.
              ...
              case 12:
                ...
                if (J.$eq$(J.$index$asx(t1.regResponse, "status"), 200)) {
                  ...
                  W._CssStyleDeclarationSet$(new W._FrozenElementList(document.querySelectorAll(".registration, .payment")))._setAll$2("display", "none");
                  t2 = document.querySelector("form .success").style;
                  t2.display = "block";
                  t2 = new W._FrozenElementList(document.querySelectorAll("form .success a.download"));
                  t2.forEach$1(t2, new R.RegisterPage_doPay_closure0(t1));
                } else {
                  V.swal(null, J.$index$asx(t1.regResponse, "message"), "Error", "error");
                  $async$self.enableForm$0();
                  // goto return
                  $async$goto = 1;
                  break;
      ...
      requestStripeToken$0: function() {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$next = [], $async$self = this, completer, cardNumber, expDay, expYear, expParts, t1, t2, exception, $async$exception, $async$temp1, $async$temp2;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                expParts = J.split$1$s(J.get$value$x(document.querySelector("#exp")), "/");
                expDay = null;
                expYear = null;
                if (0 >= expParts.length) {
                  ...
                  ;
                expDay = H.Primitives_parseInt(J.trim$0$s(expParts[0]), null, null);
                if (1 >= expParts.length) {
                  ...
                  ;
                expYear = H.Primitives_parseInt(J.trim$0$s(expParts[1]), null, null);
                $async$handler = 4;
                t1 = $async$self.stripe;
                t2 = J.get$value$x(cardNumber);
                t1.toString;
                $async$temp1 = J;
                $async$temp2 = completer;
                $async$goto = 7;
                return P._asyncHelper(t1.Request$3("tokens", "POST", P.LinkedHashMap__makeLiteral(["card", P.LinkedHashMap__makeLiteral(["number", t2, "exp_month", J.toString$0$(expDay), "exp_year", J.toString$0$(expYear)])])), $async$requestStripeToken$0, $async$completer);
              case 7:
                // returning from await.
              ...
              case 4:
                ...
                J.complete$1$x(completer, P.LinkedHashMap__makeLiteral(["status", 402, "response", P.LinkedHashMap__makeLiteral(["error", P.LinkedHashMap__makeLiteral(["type", "card_error", "code", "invalid", "message", "Your card's information is invalid."])])]));
                // goto after finally
                $async$goto = 6;
                break;
              case 3:
      ...
      addAttendee$0: function() {
        ...
        if (this.promoRemainingUses != null && J.get$length$asx(this.getFilledRegistrations$0()._source) === this.promoRemainingUses) {
        ...
        t1 = J.get$length$asx(this.getFilledRegistrations$0()._source);
      ...
      refreshDisplayedPrice$0: function() {
        ...
        regCount = J.get$length$asx(this.getFilledRegistrations$0()._source);
    ...
    RegisterPage_doPay_closure0: {
      "^": "Closure:0;_box_0",
      call$1: function(elem) {
        var t1, t2;
        H.interceptedTypeCast(elem, "$isAnchorElement");
        t1 = elem.href;
        t2 = J.join$1$ax(J.$index$asx(this._box_0.regResponse, "ids"), ",");
        if (t1 == null)
          return t1.$add();
    ...
    Stripe: {
      "^": "Object;Base,Public",
      Request$3: function(endpoint, method, body) {
        var $async$goto = 0, $async$completer = new P.Completer_Completer$sync(), $async$returnValue, $async$handler = 2, $async$currentError, $async$self = this, parts, formData, finalResult, completeNormal, t1;
        var $async$Request$3 = P._wrapJsFunctionForAsync(function($async$errorCode, $async$result) {
          if ($async$errorCode === 1) {
            $async$currentError = $async$result;
            $async$goto = $async$handler;
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                formData = C.JSArray_methods.join$1(parts, "&");
                finalResult = H.setRuntimeTypeInfo(new P._AsyncCompleter(H.setRuntimeTypeInfo(new P._Future(0, $.Zone__current, null), [null])), [null]);
                completeNormal = new B.Stripe_Request_closure0(finalResult);
                t1 = $async$self.Base;
                if (method.toUpperCase() === "GET")
                  W.HttpRequest_request(t1 + "/" + endpoint + "?" + formData, method.toUpperCase(), null, null, null, null, null, null).catchError$1(new B.Stripe_Request_closure1(completeNormal)).then$1(completeNormal);
                else
                  W.HttpRequest_request(t1 + "/" + endpoint, method.toUpperCase(), null, null, P.LinkedHashMap__makeLiteral(["Content-Type", "application/x-www-form-urlencoded"]), null, formData, null).catchError$1(new B.Stripe_Request_closure2(completeNormal)).then$1(completeNormal);
                $async$returnValue = finalResult.future;
                // goto return
                $async$goto = 1;
                break;
    ...
    Stripe_Request_closure: {
      ...
      call$2: function(key, value) {
        var t1 = J.getInterceptor(value);
        if (!!t1.$isMap) {
          t1.forEach$1(value, new B.Stripe_Request__closure(this.parts, key));
          return;
        }
        if (!!t1.$isIterable) {
    ...
    Stripe_Request__closure: {
      ...
      call$2: function(skey, elem) {
        this.parts.push(H.S(P.Uri__uriEncode(C.List_nxB, this.key, C.Utf8Codec_false, true)) + "[" + H.S(P.Uri__uriEncode(C.List_nxB, skey, C.Utf8Codec_false, true)) + "]=" + H.S(P.Uri__uriEncode(C.List_nxB, elem, C.Utf8Codec_false, true)));
      }
    },
    ...
    Stripe_Request_closure0: {
      "^": "Closure:0;finalResult",
      call$1: [function(response) {
        var t1;
        if (response == null || J.get$response$x(response) == null)
          return;
        t1 = J.getInterceptor$x(response);
        this.finalResult.complete$1(0, P.LinkedHashMap__makeLiteral(["status", t1.get$status(response), "response", C.JsonCodec_null_null.decode$1(t1.get$response(response))]));
      }, null, null, 2, 0, null, 30, "call"]
    },
    Stripe_Request_closure1: {
      "^": "Closure:0;completeNormal",
      call$1: [function(error) {
...
;
  ...
  $ = new Isolate();
  init.metadata = ["error", null, "stackTrace", "event", "e", "result", "data", "r", "_", "o", "x", "value", "element", "object", "sender", "closure", "isolate", "numberOfArguments", "arg1", "arg2", "arg3", "arg4", "each", "errorCode", "arg", "callback", "captureThis", "self", "arguments", "a", "response"];
  init.types = [{func: 1, args: [,]}, {func: 1}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, args: [, P.StackTrace]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, args: [P.String, P.String]}, {func: 1, args: [P.String,,]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [P.$int,,]}, {func: 1, v: true, opt: [,]}, {func: 1, args: [,], opt: [,]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [P.Symbol,,]}, {func: 1, ret: P.Future, args: [,]}, {func: 1, ret: P.Object, args: [,]}];
