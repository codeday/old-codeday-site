// Generated by dart2js (mirrors), the Dart to JavaScript compiler version: 1.13.2.
...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    _Deserializer: {
      ...
      }, "call$1", "get$deserialize", 2, 0, 1, 4],
    ...
    _Future: {
      ...
      }, "_completeError$1", "call$2", "call$1", "get$_completeError", 2, 2, 13, 2, 0, 1],
      $isFuture: 1,
    ...
    _StreamIteratorImpl: {
      ...
      }, "_onError$1", "call$2", "call$1", "get$_onError", 2, 2, 15, 2, 0, 1],
      _onDone$0: [function() {
        if (this._state === 2) {
    ...
    _ForwardingStreamSubscription: {
      ...
      }, "call$2", "get$_handleError", 4, 0, 16, 0, 1],
    ...
    _DataAttributeMap_forEach_closure: {
      "^": "Closure:7;_html$_captured_this_0,_html$_captured_f_1",
      call$2: function(key, value) {
    ...
    _DataAttributeMap_keys_closure: {
      "^": "Closure:7;_html$_captured_this_0,_captured_keys_1",
      call$2: function(key, value) {
        var t1 = J.getInterceptor$s(key);
        if (t1.startsWith$1(key, "data-"))
    ...
    }, "call$1", "js___convertToDart$closure", 2, 0, 19, 7],
    ...
    "^": "",
    Register: {
      "^": "Object;stripeApiPublic,currentPromo,unitPrice,displayedPrice",
          ...
          while (true)
            switch ($async$goto) {
              case 0:
                ...
                $async$temp1.querySelector("#card_number");
                $async$temp1 = document;
                $async$temp1.querySelector("#exp");
                $async$temp1 = J;
                $async$temp1 = $async$temp1;
                $async$temp2 = $;
                $async$temp1 = $async$temp1.$index$asx($async$temp2.$get$context(), "x");
                $async$temp1 = $async$temp1;
                $async$temp2 = R;
                $async$temp1.callMethod$2("x", [new $async$temp2.Register_requestStripeToken_closure()]);
                // implicit return
      ...
      addAttendee$0: function() {
        var attendeeTemplate, fields;
        attendeeTemplate = document.querySelector(".attendee").cloneNode(true);
        fields = J.querySelectorAll$1$x(attendeeTemplate, "input");
        fields.forEach$1(fields, new R.Register_addAttendee_closure());
        document.querySelector(".attendee").parentNode.appendChild(attendeeTemplate);
      },
      getFilledRegistrations$0: function() {
        var attendees = new W._FrozenElementList(document.querySelectorAll(".attendee"));
        return attendees.map$1(attendees, new R.Register_getFilledRegistrations_closure(document.querySelector("input[name=\"first_name\"]"), document.querySelector("input[name=\"first_name\"]"), document.querySelector("input[name=\"first_name\"]")));
      },
      refreshDisplayedPrice$0: function() {
        ...
        if (typeof t2 !== "number")
          return H.iae(t2);
        this.displayedPrice = t1 * t2;
        document.querySelector(".quoted-price").textContent = C.JSNumber_methods.toStringAsFixed$1(this.displayedPrice, 2);
      },
      Register$0: function() {
        var t1 = document.querySelector(".payment");
        t1.toString;
        this.unitPrice = P.num_parse(t1.getAttribute("data-" + new W._DataAttributeMap(new W._ElementAttributeMap(t1))._toHyphenedName$1("defaultUnitPrice")), null);
        this.refreshDisplayedPrice$0();
        t1 = document.querySelector(".card");
        t1.toString;
        this.stripeApiPublic = t1.getAttribute("data-" + new W._DataAttributeMap(new W._ElementAttributeMap(t1))._toHyphenedName$1("stripePk"));
        J.$index$asx($.$get$context(), "Stripe").callMethod$2("setPublishableKey", [this.stripeApiPublic]);
        t1 = J.get$onClick$x(document.querySelector(".add-attendee"));
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.Register_closure(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
        t1 = J.get$onClick$x(document.querySelector(".pay"));
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new R.Register_closure0(this)), false), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      },
      static: {Register$: function() {
          var t1 = new R.Register(null, null, 10, 0);
          t1.Register$0();
          return t1;
        }}
    },
    Register_closure: {
      "^": "Closure:1;_register$_captured_this_0",
    ...
    Register_closure0: {
      ...
      call$1: [function($event) {
        this._captured_this_1.requestStripeToken$0();
        P.print("done");
      }, null, null, 2, 0, null, 8, "call"]
    },
    Register_requestStripeToken_closure: {
      "^": "Closure:0;",
      call$0: [function() {
        return P.print("foo");
      }, null, null, 0, 0, null, "call"]
    },
    Register_addAttendee_closure: {
      "^": "Closure:1;",
    ...
    Register_getFilledRegistrations_closure: {
      "^": "Closure:1;_captured_fnElem_0,_captured_lnElem_1,_captured_emElem_2",
      call$1: [function(a) {
        return new T.Registration(J.get$value$x(this._captured_fnElem_0), J.get$value$x(this._captured_lnElem_1), J.get$value$x(this._captured_emElem_2));
      }, null, null, 2, 0, null, 29, "call"]
    }
  }], ["", "../../../resources/dart/web/registration.dart",, T, {
    "^": "",
    Registration: {
...
;
  ...
  $ = new Isolate();
  init.metadata = ["error", "stackTrace", null, "data", "x", "_", "result", "o", "event", "object", "sender", "e", "closure", "isolate", "numberOfArguments", "arg1", "arg2", "arg3", "arg4", "each", "errorCode", "value", "ignored", "element", "arg", "callback", "captureThis", "self", "arguments", "a"];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, v: true}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, args: [, P.StackTrace]}, {func: 1, args: [,], opt: [,]}, {func: 1, ret: P.String, args: [P.$int]}, {func: 1, args: [P.String, P.String]}, {func: 1, args: [P.String,,]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [P.$int,,]}, {func: 1, v: true, args: [,], opt: [P.StackTrace]}, {func: 1, ret: P.bool}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, v: true, args: [, P.StackTrace]}, {func: 1, args: [,,]}, {func: 1, args: [P.Symbol,,]}, {func: 1, ret: P.Object, args: [,]}];
